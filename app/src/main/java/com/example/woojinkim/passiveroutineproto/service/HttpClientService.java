...
/**
 * Created by woojinkim on 2017. 10. 14..
 */
...
public class HttpClientService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new JSONTask().execute("http://52.79.180.194:8000/post");//AsyncTask 시작시킴
            }
        });
    }
